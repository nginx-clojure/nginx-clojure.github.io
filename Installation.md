...
1. First you can download  Release 0.5.0  from [here](https://sourceforge.net/projects/nginx-clojure/files/). 
...
1. Create the jar file about Nginx-Clojure
	...
	$ lein jar
	```
	Then you'll find nginx-clojure-${version}.jar (eg. nginx-clojure-0.5.0.jar) in the target folder. 
